    ...
    private static void postSingleMetadata(JSONObject singleContent,
        ...
        try {
            ...
            StringEntity se2 = new StringEntity(
                    "{\"@context\":[\"https://clowder.ncsa.illinois.edu/contexts/metadata.jsonld\",{\"Funding Institution\":\"http://sead-data.net/terms/FundingInstitution\"}],\"dataset_id\":\"583314110d15772a7e37cd90\",\"content\":{\"Funding Institution\":\"r�\"}}", "UTF-8");
